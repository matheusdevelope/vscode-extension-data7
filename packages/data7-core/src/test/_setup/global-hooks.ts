...
import { installVscodeApi } from "../../platform/vscode-api";
import { createVscodeAnalysisHost, installAnalysisHost } from "../../analysis/analysis-host";
 ...
 *  3. Reinstall the VS Code-backed {@link AnalysisHost} so open-document
 *     lookups stay wired to the mock `textDocuments` array.
 *
