...
- `packages/data7-lsp/`: Language Server Protocol (`@data7/lsp`). Processo stdio que reinstala o `AnalysisHost`, indexa o workspace e publica diagnósticos. Ativado pela extensão quando `features.diagnostics.useLanguageServer` é `true` (default `false`). Ver `docs/rfcs/LSP-001-language-server.md`.
