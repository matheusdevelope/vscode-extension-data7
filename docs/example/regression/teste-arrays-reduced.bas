...
' @diagnostics: typed-const-unsupported@26, invalid-shared-member@23, redundant-public-modifier@25, loose-value-statement@28, abstract-instantiation@29, sealed-inheritance@15, mustoverride-not-implemented@18
'
