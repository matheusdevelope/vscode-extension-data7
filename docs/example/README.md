...
Todo arquivo `.bas` em `docs/example/` **deve** começar com um bloco de comentários no formato:
...
| [`sugar/for-each/_expected/01-stringlist-explicit-type.bas`](./sugar/for-each/_expected/01-stringlist-explicit-type.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/for-each/01-stringlist-explicit-type | `none` | — |
| [`sugar/for-each/_expected/02-stringlist-implicit-type.bas`](./sugar/for-each/_expected/02-stringlist-implicit-type.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/for-each/02-stringlist-implicit-type | `none` | — |
| [`sugar/for-each/_expected/03-nested-loops.bas`](./sugar/for-each/_expected/03-nested-loops.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/for-each/03-nested-loops | `none` | — |
...
| [`sugar/object-init/_expected/01-basic.bas`](./sugar/object-init/_expected/01-basic.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/object-init/01-basic | `none` | — |
| [`sugar/object-init/01-basic.bas`](./sugar/object-init/01-basic.bas) | New T() With { .X = v, .Y = w } expandido para With block | `none` | — |
| [`sugar/optional-chain/_expected/01-property-access.bas`](./sugar/optional-chain/_expected/01-property-access.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/optional-chain/01-property-access | `none` | — |
| [`sugar/optional-chain/_expected/02-method-call.bas`](./sugar/optional-chain/_expected/02-method-call.bas) | Forma nativa gerada pelo SugarTranspiler para sugar/optional-chain/02-method-call | `none` | — |
