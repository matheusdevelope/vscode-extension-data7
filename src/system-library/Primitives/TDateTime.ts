...
export const symbols: SystemSymbolInfo[] = [
...

  {
    ...
    fileUri: "system://library",
    containerName: "TDateTime",
    description: "Retorna os milissegundos correspondentes.",
  },
  {
    name: "Now",
    kind: "method",
  ...
  },
  {
    ...
    fileUri: "system://library",
    containerName: "TDateTime",
    description: "Converte o TDateTime em um inteiro de 32 bits.",
  },
  {
    name: "EncodeDateTime",
    kind: "method",
    ...
    isPrivate: false,
    parameters: [
      { name: "pYear", type: "Integer", isByRef: false, isOptional: false },
      { name: "pMonth", type: "Integer", isByRef: false, isOptional: false },
      { name: "pDay", type: "Integer", isByRef: false, isOptional: false },
